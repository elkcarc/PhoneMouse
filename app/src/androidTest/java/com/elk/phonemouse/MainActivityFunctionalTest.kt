...
class MainActivityFunctionalTest {
    ...
    fun testNoDeleteConfirmationWhenDisabled() {
        ActivityScenario.launch(MainActivity::class.java).use { scenario ->
            ...
            scrollable.scrollIntoView(UiSelector().resourceId("com.elk.phonemouse:id/confirmDeleteToggle"))
            val toggle = device.findObject(UiSelector().resourceId("com.elk.phonemouse:id/confirmDeleteToggle"))
    ...
    fun testSensitivitySettingsFunctionalEffect() {
        ...
        ActivityScenario.launch(MainActivity::class.java).use { scenario ->
            ...
            onView(withId(R.id.settingsBtn)).perform(click())
            Thread.sleep(500)
            val slider = device.findObject(UiSelector().resourceId("com.elk.phonemouse:id/trackpadSensitivitySlider"))
    ...
    fun testDragAndDropPersistence() {
        ActivityScenario.launch(MainActivity::class.java).use { scenario ->
            ...
            val rv = device.findObject(UiSelector().resourceId("com.elk.phonemouse:id/configsRecyclerView"))
    ...
    fun testTrackpointCurvePacketEffect() {
        ...
        ActivityScenario.launch(MainActivity::class.java).use { scenario ->
            ...
            val scrollable = UiScrollable(UiSelector().scrollable(true))
            scrollable.scrollIntoView(UiSelector().resourceId("com.elk.phonemouse:id/trackpointCurveDropdown"))
