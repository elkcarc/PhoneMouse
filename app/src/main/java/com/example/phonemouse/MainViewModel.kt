...
class MainViewModel @JvmOverloads constructor(
    ...
    val uiState = combine(
        ...
        mouseHidService.flatMapLatest { it?.isTestModeFlow() ?: flowOf(value = false) },
        repo.recordings,
        ...
        MainUiState(
            ...
            isTestMode = p[5] as Boolean,
            hasRecording = (p[6] as List<InputRecording>).isNotEmpty(),
            recordings = p[6] as List<InputRecording>,
            selectedRecordingIndex = p[7] as Int,
            configs = p[8] as List<AutomationConfig>,
            selectedConfigIndex = p[9] as Int,
            confirmDelete = p[10] as Boolean,
            appLanguage = p[11] as String,
            themeMode = p[12] as String,
            isSettingsVisible = p[13] as Boolean,
            activePanel = p[14] as String,
            trackpadMode = p[15] as String,
            isTrailEnabled = p[16] as Boolean,
            trackpadSensitivity = p[17] as Float,
            trackpadAcceleration = p[18] as Float,
